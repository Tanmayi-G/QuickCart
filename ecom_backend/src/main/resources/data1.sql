INSERT INTO product (name, desc, brand, price, category, release_date, available, quantity) VALUES
  ...
  ('Maruti Suzuki', 'A popular hatchback known for its fuel efficiency and reliability.', 'Maruti Suzuki', 550000.00, 'Cars', '2024-02-01', true, 100),
  ('Hyundai Creta', 'A stylish SUV with advanced features and comfortable interiors.', 'Hyundai', 950000.00, 'Cars', '2024-03-01', true, 75),
